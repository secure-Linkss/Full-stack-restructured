...
const Security = () => {
	...
	const metricCards = [
		{ title: 'Total Blocks', value: (metrics.totalBlocks || 0).toLocaleString(), icon: ShieldAlert, change: 1.5 },
		{ title: 'Bot Traffic %', value: `${metrics.botTrafficPercentage || 0}%`, icon: Shield, change: -0.5 },
		{ title: 'Rate Limit Hits', value: (metrics.rateLimitHits || 0).toLocaleString(), icon: AlertTriangle, change: 3.1 },
	];
