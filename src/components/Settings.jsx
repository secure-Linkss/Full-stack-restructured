...
const NotificationSettings = () => {
	...
	const handleTestNotification = async () => {
		...
		try {
			...
			// const token = localStorage.getItem('token') || sessionStorage.getItem('token'); // Handled by api service
			...
			setTestStatus('error');
			toast.error(error.message || 'Failed to send test notification. Check your token and chat ID.');
		} finally {
			setTesting(false);
		}
	};
